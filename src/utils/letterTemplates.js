...
const RAW_TEMPLATES = {
  ...
  I: [
    { x: 25, y: 0 }, { x: 75, y: 0 },       // top crossbar
    { x: 50, y: 0 }, { x: 50, y: 100 },      // vertical stroke
    { x: 25, y: 100 }, { x: 75, y: 100 },    // bottom crossbar
  ],
  L: [
  ...
  1: [
    { x: 35, y: 25 }, { x: 50, y: 0 }, { x: 50, y: 100 }, { x: 30, y: 100 }, { x: 70, y: 100 },
  ],
  7: [
