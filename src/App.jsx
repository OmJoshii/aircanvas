...
const gestures = [
  { icon: '🤏', label: 'Pinch to Draw',      desc: 'Touch index finger and thumb',     accent: '#818cf8' },
  { icon: '✊', label: 'Fist to Erase',       desc: 'Curl all fingers into a fist',     accent: '#f472b6' },
  { icon: '🖐️', label: 'Both Palms — Clear', desc: 'Open both hands to wipe canvas',   accent: '#34d399' },
  { icon: '👐', label: 'Distance = Brush',    desc: 'Spread hands to grow brush',       accent: '#fbbf24' },
]
    ...
    <div className="w-screen h-screen bg-[#07070f] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-10 flex items-center gap-16">
        ...
        <div className="flex-1 flex flex-col items-start">
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full mb-8 text-xs font-medium"
            style={{ background: 'rgba(129,140,248,0.12)', border: '1px solid rgba(129,140,248,0.3)', color: '#a78bfa' }}>
            <span>✦</span><span>Gesture — Powered Art</span>
          </div>

          <h1 className="text-7xl font-bold leading-none tracking-tight mb-5"
            style={{
          ...
          <p className="text-white/20 text-xs mt-4">Camera permission will be requested on start</p>
        </div>
        ...
        <div className="flex-1 grid grid-cols-2 gap-3">
          {gestures.map(g => (
            ...
            >
              ...
              <div className="h-0.5 w-8 rounded-full mt-auto"
